var BEMHTML = (function(exports) {
        ...
        if (__t === "attrs") {
            ...
            if (__t === "b-page") {
                ...
                if (this.elem === "core") {
                    ...
                    }, __r35 = apply.call(__this), this._mode = __r33, this.ctx = __r34, "", __r35;
                    return;
                } else {
                    return $99.call(this);
                }
    ...
    function $120() {
        ...
        var __r18, __r8, __r12, __r13, __r14, __r15, __r16, __r17, __r9, __r19, __r22, __r23, __r24, __r25, __r26, __r27;
        {
            ...
            tag = ("", __r8 = this._mode, this._mode = "tag", __r9 = apply.call(__this), this._mode = __r8, "", __r9);
            typeof tag != "undefined" || (tag = v.tag);
            typeof tag != "undefined" || (tag = "div");
            if (tag) {
                var jsParams, js;
                if (this.block && v.js !== false) {
                    js = ("", __r12 = this._mode, this._mode = "js", __r13 = apply.call(__this), this._mode = __r12, "", __r13);
                ...
                undefined;
                buf.push("<", tag);
                var isBEM = ("", __r14 = this._mode, this._mode = "bem", __r15 = apply.call(__this), this._mode = __r14, "", __r15);
                typeof isBEM != "undefined" || (isBEM = typeof v.bem != "undefined" ? v.bem : v.block || v.elem);
                var cls = ("", __r16 = this._mode, this._mode = "cls", __r17 = apply.call(__this), this._mode = __r16, "", __r17);
                cls || (cls = v.cls);
                ...
                if (isBEM || cls) {
                    ...
                    if (isBEM) {
                        ...
                        var mix = ("", __r18 = this._mode, this._mode = "mix", __r19 = apply.call(__this), this._mode = __r18, "", __r19);
                ...
                undefined;
                if (jsParams) {
                    var jsAttr = ("", __r22 = this._mode, this._mode = "jsAttr", __r23 = apply.call(__this), this._mode = __r22, "", __r23);
                    buf.push(" ", jsAttr || "onclick", '="return ', this._.attrEscape(JSON.stringify(jsParams)), '"');
                } else {
                    undefined;
                }
                undefined;
                var attrs = ("", __r24 = this._mode, this._mode = "attrs", __r25 = apply.call(__this), this._mode = __r24, "", __r25);
            ...
            if (this._.isShortTag(tag)) {
                ...
                tag && buf.push(">");
                var content = ("", __r26 = this._mode, this._mode = "content", __r27 = apply.call(__this), this._mode = __r26, "", __r27);
